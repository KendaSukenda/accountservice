...
func (repo *repo) CreateCustomer(ctx context.Context, customer model.Customer) error {
...
func (repo *repo) UpdateCustomer(ctx context.Context, customer model.Customer) (string, error) {
